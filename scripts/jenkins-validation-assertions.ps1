...
function Assert-SeedJobSafety {
    ...
    Assert-TextContains -Text $seedJob -Expected "def hasConcreteScmValues =" -Message "Seed job should detect concrete SCM metadata before artifact archiving."
    Assert-TextContains -Text $seedJob -Expected "Skipping generated Job DSL artifact archive because concrete SCM values or credential IDs were supplied." -Message "Seed job should avoid archiving generated DSL that includes concrete SCM metadata."
